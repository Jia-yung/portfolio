                            ...
                            <Col xs={12} sm={12} md={8}>
                                <ScrollAnimation animateIn="fadeIn">
                                    ...
                                    <div className="pull-right">                                   
                                        <a href="mailto:yapjiayung@gmail.com" target="_blank" rel="noopener noreferrer" class="btn btn-outline-secondary" ><i className="fa fa-envelope" aria-hidden="true" style={{marginRight: '10px'}}/>Email</a>
                                    </div>                              
                                ...
                                <Col xs={12}>
                                    <Accordion>
                                        ...
                                        <Card>
                                            ...
                                            <Card.Body className="text-justify">Peer Assisted Learning Programme (PALP) is a peer facilitated student support scheme for students who would like to improve their studies. Peer leaders who excel in certain subjects are trained to foster student learning and active engagement with their course content. In this program, I am choosens to be the peer leader for Computer Mathematics and Computer Organisation to assist my junior who have difficulties in that area of studies.</Card.Body>
                                            </Accordion.Collapse>
                                        </Card>
                                        <Card>
                                            <Card.Header>
                                            ...
                                            <Card.Body>In this state level competition, I participated for the team of 4 event representing my school and we secured 3rd place for three consecutive years.</Card.Body>
                                            </Accordion.Collapse>
                                        </Card>
                                    </Accordion>
                                </Col>                            
